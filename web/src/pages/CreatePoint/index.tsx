...
const CreatePoint = () => {
    ...
    //Sempre que criar um array ou objeto devemos setar o tipo
    ...
    useEffect(() => {
        ...
        axios.get<IBGECidadeResponse[]>(`https://servicodados.ibge.gov.br/api/v1/localidades/estados/${selectedUf}/municipios`)
            .then(response => {
                const citiesName = response.data.map<IBGECidadeResponse>(c => ({ id: c.id, nome: c.nome }));
            ...
            <form onSubmit={handleSubmit}>
                ...
                <fieldset>
                    ...
                    <div className="field-group">
                        ...
                        <div className="field">
                            <label htmlFor="cidy">Cidade</label>
                            <select name="cidy" id="cidy" value={selectedCity} onChange={handleSelectCity} >
